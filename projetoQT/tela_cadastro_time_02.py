...
"border: 1px solid white;\n"
"border-radius: 5px;")
        self.label_times_3.setPixmap(QPixmap(u":/times/add_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg"))
        ...
        self.label_times_4.setGeometry(QRect(30, 260, 641, 51))
        self.label_times_4.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid white;\n"
"border-radius: 5px;")
        self.label_times_4.setPixmap(QPixmap(u":/times/add_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg"))
        ...
        self.cadastrar_time_2.setGeometry(QRect(30, 370, 631, 51))
